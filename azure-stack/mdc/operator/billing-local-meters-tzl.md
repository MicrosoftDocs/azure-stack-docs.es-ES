---
title: 'Medidores de facturación locales: MDC | Microsoft Docs'
description: Consulte una lista con los medidores de Azure Stack locales que se usan cuando se trabaja desde un Centro de datos modular (MDC).
...
ms.locfileid: "100562577"
---
# <a name="local-azure-stack-billing-meters---modular-data-center-mdc"></a>Medidores de facturación de Azure Stack locales: Centro de datos modular (MDC)
