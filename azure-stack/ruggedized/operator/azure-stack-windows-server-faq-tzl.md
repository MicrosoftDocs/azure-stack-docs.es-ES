...
## <a name="what-about-other-vms-that-use-windows-server-such-as-sql-server"></a>¿Qué ocurre con otras máquinas virtuales que usan Windows Server, como SQL Server?
