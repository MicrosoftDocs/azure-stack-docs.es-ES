...
- Un Kit de desarrollo de Azure Stack (ASDK) o una suscripción a un sistema integrado de Azure Stack Hub. Para implementar el ASDK, siga las instrucciones que encontrará en el artículo acerca de la [implementación del Kit de desarrollo de Azure Stack mediante el instalador](../asdk/asdk-install.md).
