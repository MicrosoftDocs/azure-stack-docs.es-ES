...
La desactivación de la telemetría de Windows y de Azure Stack deshabilita la de SQL. Para más información acerca de las implicaciones de la configuración de telemetría de Windows Server, consulte las [Notas del producto de telemetría de Windows](/windows/privacy/configure-windows-diagnostic-data-in-your-organization).
