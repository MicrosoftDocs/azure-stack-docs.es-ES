...
Para más información acerca del uso de VMM para realizar una implementación del sistema operativo en equipos sin este, consulte [Aprovisionamiento de un host o clúster de Hyper-V de equipos sin sistema operativo](/system-center/vmm/hyper-v-bare-metal?view=sc-vmm-2019).
