...
1. Inicie sesión en el portal de administración de Azure Stack Hub (https://adminportal.local.azurestack.external) como administrador de servicios.
