...
1. Inicie sesión en el portal de administración de Azure Stack Hub como administrador del servicio.
...
8. Establezca el **URI de redirección de OAuth 2** y, a continuación, haga clic en **Agregar**. En una implementación de Azure Stack Hub predeterminada, el URI de redirección tiene el formato `https://portal.<region>.<FQDN>/TokenAuthorize`. 
