---
title: Validación de certificados de infraestructura de clave pública de Azure Stack Hub para la implementación de sistemas integrados de Azure Stack Hub
