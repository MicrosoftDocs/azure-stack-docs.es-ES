...
description: Más información sobre la actualización 1904 para sistemas integrados de Azure Stack.
...
- [Problemas conocidos](known-issues-1904.md)
...
> [!NOTE]
> Asegúrese de que usa la versión más reciente de la herramienta [Azure Stack Capacity Planner](https://aka.ms/azstackcapacityplanner) para realizar el planeamiento y el ajuste de tamaño de la carga de trabajo. La última versión contiene correcciones de errores y proporciona nuevas características que se publican con cada actualización de Azure Stack.
