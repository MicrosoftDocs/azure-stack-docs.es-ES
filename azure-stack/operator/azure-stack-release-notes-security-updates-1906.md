---
title: 'Notas de la versión de Azure Stack: actualizaciones de seguridad para la versión 1906 | Microsoft Docs'
description: Obtenga información sobre las actualizaciones de seguridad para la versión 1906 de Azure Stack.
...
Debido a la naturaleza acumulativa de las actualizaciones de Windows, esta actualización también contiene las cargas útiles de seguridad de los meses anteriores. La lista de CVE anterior refleja la carga útil de seguridad de marzo, abril y mayo de 2019.
Para obtener más información sobre estas vulnerabilidades, haga clic en los vínculos anteriores o consulte los artículos de Microsoft Knowledge Base [4499177](https://support.microsoft.com/en-us/help/4499177).

## <a name="1904-update"></a>Actualización 1904

Esta actualización de Azure Stack no incluye actualizaciones de seguridad para el sistema operativo subyacente que hospeda Azure Stack.

## <a name="1903-update"></a>Actualización 1903

Esta actualización de Azure Stack no incluye actualizaciones de seguridad para el sistema operativo subyacente que hospeda Azure Stack.  

## <a name="1902-update"></a>Actualización 1902

La actualización 1902 instala las actualizaciones de seguridad siguientes:  
