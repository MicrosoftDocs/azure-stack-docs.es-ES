---
title: 'Notas de la versión de Azure Stack: actualizaciones de seguridad para la versión 1908 | Microsoft Docs'
description: Obtenga información sobre las actualizaciones de seguridad para la versión 1908 de Azure Stack.
...
## <a name="1908-update"></a>Actualización 1908
...
Debido a la naturaleza acumulativa de las actualizaciones de Windows, esta actualización también contiene las cargas útiles de seguridad de los meses anteriores. Esta lista de CVE refleja la carga útil de seguridad de junio, julio y agosto de 2019.
Para más información sobre estas vulnerabilidades, haga clic en los vínculos anteriores o consulte el artículo de Microsoft Knowledge Base [4511553](https://support.microsoft.com/help/4511553).

::: moniker-end

::: moniker range="azs-1907"
## <a name="1907-update"></a>Actualización 1907
...
## <a name="1906-update"></a>Actualización 1906

Esta actualización de Azure Stack no incluye actualizaciones de seguridad para el sistema operativo subyacente que hospeda Azure Stack.
::: moniker-end

::: moniker range="azs-1905"
## <a name="1905-update"></a>Actualización 1905

La actualización 1905 instala las actualizaciones de seguridad siguientes:
...
Debido a la naturaleza acumulativa de las actualizaciones de Windows, esta actualización también contiene las cargas útiles de seguridad de los meses anteriores. Esta lista de CVE refleja la carga útil de seguridad de marzo, abril y mayo de 2019.
Para obtener más información sobre estas vulnerabilidades, haga clic en los vínculos anteriores o consulte los artículos de Microsoft Knowledge Base [4499177](https://support.microsoft.com/help/4499177).
::: moniker-end

## <a name="next-steps"></a>Pasos siguientes

- [Revisión de la lista de comprobación de actividades de actualización](azure-stack-release-notes-checklist.md)
- [Revisión de la lista de problemas conocidos](azure-stack-release-notes-known-issues-1908.md)
