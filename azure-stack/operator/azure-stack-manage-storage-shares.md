...
Si la capacidad libre restante de un volumen está limitada, planee [administrar el espacio disponible](#manage-available-space) para evitar que los recursos compartidos se queden sin capacidad.
