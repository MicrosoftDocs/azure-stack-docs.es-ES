...
> [!IMPORTANT]
> Antes de ejecutar la actualización, debe completar [implementación de Azure App Service en Azure Stack Hub en un entorno sin conexión](azure-stack-app-service-deploy-offline.md). 
