...
- Se muestra ahora un mensaje de error en el portal de administración de App Service cuando el panel de control del proveedor de recursos no puede conectarse a la instancia de SQL Server configurada.
