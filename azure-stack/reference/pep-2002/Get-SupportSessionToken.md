---
title: Punto de conexión con privilegios de Get-SupportSessionToken para Azure Stack Hub
description: 'Referencia del punto de conexión con privilegios de Azure Stack para PowerShell: Get-SupportSessionToken'
author: mattbriggs
ms.topic: reference
ms.date: 04/27/2020
ms.author: mabrigg
