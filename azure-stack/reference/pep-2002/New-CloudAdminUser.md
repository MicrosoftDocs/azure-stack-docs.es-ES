---
title: Punto de conexión con privilegios de New-CloudAdminUser para Azure Stack Hub
description: 'Referencia del punto de conexión con privilegios de Azure Stack para PowerShell: New-CloudAdminUser'
author: mattbriggs
ms.topic: reference
ms.date: 04/27/2020
ms.author: mabrigg
