---
title: Creación de un túnel de VPN mediante GRE en Azure Stack | Microsoft Docs
description: Aprenda a crear un túnel de VPN mediante GRE en Azure Stack.
...
ms.locfileid: "73168304"
---
# <a name="how-to-create-a-vpn-tunnel-using-gre-in-azure-stack"></a>Creación de un túnel de VPN mediante GRE en Azure Stack
...
Este patrón de implementación es la base que le permitirá crear túneles de VPN no solo dentro de la instancia de Azure Stack, sino también entre instancias de Azure Stack y otros recursos, como las redes locales con el uso de túneles de VPN de sitio a sitio de RRAS de Windows.
...
![texto alternativo](./media/azure-stack-network-howto-vpn-tunnel-gre/overview.png)
...
![texto alternativo](./media/azure-stack-network-howto-vpn-tunnel-gre/s2svpntunnel.png)
